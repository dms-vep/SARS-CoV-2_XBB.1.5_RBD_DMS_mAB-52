# Deep mutational scanning of SARS-CoV-2 XBB.1.5 RBD and mAb-52 escape mapping
Study by Bernadeta Dadonaite and Jesse Bloom.

This repo contains mAbs-52 escape mapping data using XBB.1.5 RBD pseudovirus-based DMS libraries.  

For documentation of the analysis, see [https://dms-vep.github.io/SARS-CoV-2_XBB.1.5_RBD_DMS_mAB-52/](https://dms-vep.github.io/SARS-CoV-2_XBB.1.5_RBD_DMS_mAB-52/)
